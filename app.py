...
class DocumentosLegalesPDF:
    ...
    def generar_riohs(self, data):
        ...
        legal_3 = """Este reglamento puede entregarse en formato electrónico conforme se expresa en el ordinario N°1086 de la Dirección del Trabajo, siempre que el trabajador cuente con los medios para acceder a él."""
            ...
            with tab_ind:
                ...
                if st.button("Registrar Entrega RIOHS", type="primary"):
                    ...
                    if valid and nom_dif:
                        b_w = io.BytesIO(); img_w_final.save(b_w, format='PNG'); str_w = base64.b64encode(b_w.getvalue()).decode()
                        b_d = io.BytesIO(); img_d_final.save(b_d, format='PNG'); str_d = base64.b64encode(b_d.getvalue()).decode()
