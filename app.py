...
DB_NAME = 'sgsst_v156_final_riohs.db' # Misma DB
...
st.markdown(f"""
    ...
    /* FIX V161: BORDE VISIBLE PARA LOS CUADROS DE FIRMA */
    /* Apunta directamente al contenedor del canvas para darle borde gris sólido */
