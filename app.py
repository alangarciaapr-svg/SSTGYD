...
# ==============================================================================
# 2. LISTAS Y FUNCIONES DE SOPORTE
# ==============================================================================
...
IRL_DATA_DB = {
    "OPERADOR DE MAQUINARIA": {
        ...
        "medidas_txt": "Uso de cinturón, Cabina ROPS/FOPS, Extintor PQS, LOTO en mantención.",
    ...
    "MOTOSIERRISTA": {
        ...
        "riesgos_txt": "Cortes, Golpe por rama, Vibración, Ruido, Caída.",
        "medidas_txt": "EPP Anticorte completo, Freno de cadena, Pausas activas.",
        "metodos_txt": "Técnica de tala dirigida, Vía de escape 45°, Sujeción firme.",
        "sustancia": "MEZCLA"
    },
    "DEFAULT": {
        "espacio": "Instalaciones generales de la empresa.",
        "ambiente": "Iluminación adecuada. Ventilación natural.",
        "orden": "Pasillos despejados.",
        "maquinas": "Herramientas manuales generales.",
        "riesgos_txt": "Caída mismo nivel, Golpes.",
        "medidas_txt": "Uso de EPP básico, Orden y aseo.",
        "metodos_txt": "Seguir procedimientos de trabajo seguro.",
        "sustancia": "N/A"
    }
}
# Asignar resto
...
# ==============================================================================
# 3. MOTORES PDF (RESTAURADOS Y ACTUALIZADOS)
# ==============================================================================
...
def generar_pdf_asistencia_rggd02(id_cap):
    ...
    try:
        ...
        t_row1 = Table([[h_act, h_rel, h_lug, h_fec], [d_act, d_rel, d_lug, d_fec]], colWidths=[190, 130, 120, 100]); t_row1.setStyle(TableStyle([('BACKGROUND', (0,0), (-1,0), G_CORP), ('GRID', (0,0), (-1,-1), 1, colors.black), ('VALIGN', (0,0), (-1,-1), 'MIDDLE')])); elements.append(t_row1)
        ...
        if foto_b64 and len(str(foto_b64)) > 100:
            try: img_bytes_ev = base64.b64decode(foto_b64); tf = tempfile.NamedTemporaryFile(delete=False, suffix=".jpg"); tf.write(img_bytes_ev); tf.close(); img_evidencia = Image(tf.name, width=270, height=160)
            except: pass
...
def generar_pdf_irl(data):
    ...
    try:
        ...
        data_act = [
            ["Nombre Actividad:", "Inducción IRL", "Fechas:", f"{data['fecha_inicio']} al {data['fecha_termino']}"],
...
# === NUEVO GENERADOR IRL V66 (RESTAURADA LOGICA SOLICITADA) ===
    ...
    if sel_user:
        ...
        with st.form("form_irl_ds44"):
            ...
            txt_riesgos = st.text_area("Riesgos / Consecuencias", value=data_base.get('riesgos_txt', ''), height=100)
            txt_medidas = st.text_area("Medidas Preventivas (EPP/Control)", value=data_base.get('medidas_txt', ''), height=100)
            txt_metodos = st.text_area("Métodos de Trabajo Correcto", value=data_base.get('metodos_txt', ''), height=100)
